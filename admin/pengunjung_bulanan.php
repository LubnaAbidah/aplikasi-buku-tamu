        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="index.php?menu=4">Pengunjung Bulan Ini</a></li>
        </ol>
                       ...
                       <?php function curd_read()
                        {
                          ...
                          ?>
                                            ...
                                            <div class="card mb-3">
                                              ...
                                              <div class="card-body">
                                                <a href="index.php?menu=4&a=tambah" class="btn btn-secondary btn-sm">
                                                ...
                                                <div class="table-responsive">
                                                  <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-sm btn-outline-dark href="href="index.php?menu=4&a=detail&id=<?php echo intval($baris['id_tamu']); ?>"> <span class="fab fa-fw fas fa-eye" aria-hidden="true"></span></a>
                                                          <a class="btn btn-sm btn-outline-dark href="href="index.php?menu=4&a=edit&id=<?php echo intval($baris['id_tamu']); ?>"> <span class="fab fa-fw fas fa-pencil-alt" aria-hidden="true"></span></a>
                                                          <a class="btn btn-sm btn-outline-dark href="href="index.php?menu=4&a=hapus&id=<?php echo intval($baris['id_tamu']); ?>"> <span class="fab fa-fw fas fa-trash" aria-hidden="true"></span></a></td>
                                                    </tr>
                                                           <?php
                                                             $i++;
                                                            }
...
<?php function curd_create() { ?>
          ...
          <div class="card-body">
              <form class="form-horizontal" method="post" action="index.php?menu=4&a=reset">
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-8">
                              ...
                              <a href="index.php?menu=4&a=reset" class="btn btn-danger">Batal</a>
                          </div>
                      </div>
                  </form>
              </div>
...
?>
          ...
          <div class="card-body">
              ...
              <a href="index.php?menu=4&a=reset"style="color:white;" class="btn btn-danger btn-lg">Batal</a></p>
              </form>
...
function sql_insert()
{
  ...
  mysqli_query($kdb, $sql) or die(mysql_error());
              if($sql){
           echo "<script>alert('Data anda berhasil di simpan!');window.location = 'index.php?menu=4'</script>";
...
function sql_update()
{
  ...
  mysqli_query($kdb, $sql) or die( mysql_error());
                if($sql){
           echo "<script>alert('Data anda berhasil di ubah!');window.location = 'index.php?menu=4'</script>";
...
function sql_delete()
{
  ...
  mysqli_query($kdb, $sql) or die( mysql_error());
       if($sql){
           echo "<script>alert('Data anda berhasil di hapus!');window.location = 'index.php?menu=4'</script>";
